...
class DataProcessor(ABC):
    ...
    def __init__(self, parent_name : str):
        ...
        self.known_reqs : set[MeasurementRequest] = set()       # requests generated by me or others
        self.generated_reqs : set[MeasurementRequest] = set()   # requests generated by me only
    ...
    def process(self, incoming_reqs : list, observations : list) -> list:
        ...
        for instrument,observation_data in observations:
            for obs in observation_data:
                ...
                self.generated_reqs.add(measurement_req)
    ...
    def process_observation(self, 
        ...
        if len(self.events.columns) <= 6:
            observed_events = [ (lat_event,lon_event,t_start,duration,severity,measurements)
                                ...
                                and instrument in measurements
        ...
        if observed_events:
            ...
            observations_required.remove(instrument)
