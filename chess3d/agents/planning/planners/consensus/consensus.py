...
class AbstractConsensusReplanner(AbstractReplanner):    
    ...
    def update_percepts(self, 
        ...
        new_req_bids : list[Bid] = self.compile_new_measurement_request_bids(state, current_plan)
    ...
    def _compile_completed_measurements(self, 
        ...
        completed_measurements.extend([action_from_dict(**msg.observation_action) 
                                       for msg in misc_messages
